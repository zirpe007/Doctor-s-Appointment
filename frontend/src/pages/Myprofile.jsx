...
const Myprofile = () => {
  ...
  return  userData &&(
...

    {
      ...
      <div className="mt-10">{
           isEdit
           ? <button className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transtion-all" onClick={updateUserProfileData}> Save Information</button>
           : <button className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transtion-all" onClick={()=>setIsEdit(true)}>Edit</button>
        }</div>
    </div>
  );
};
